...
def health(request: Request) -> HealthResponse:
    ...
    return HealthResponse(
        ...
        runtime_instance_id=services.runtime_instance.runtime_instance_id,
        started_at=services.runtime_instance.started_at,
        process_id=services.runtime_instance.process_id,
        hostname=services.runtime_instance.hostname,
        time=utc_now(),
